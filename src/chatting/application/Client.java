...
public class Client implements ActionListener{
    ...
    Client() {
        ...
        Image i14  = i13.getImage().getScaledInstance(8,25,Image.SCALE_DEFAULT);
    ...
    public static void main(String[] args) {
        new Client();
        try {
           Socket a = new Socket("127.0.0.1",6001); 
           DataInputStream din = new DataInputStream(a.getInputStream());
           dout = new DataOutputStream(a.getOutputStream());
